...
if (window.top != window.self){ //don't run on frames or iframes
  ...
  var EMOTES = [].concat(TI4_COMP, DESPAIR, DOTA_CINEMA, RUNES, TI4_GEMS, DAC15, BTS, ARCANA, TI5_COMP, EXTRA_EMOTES);
